...
class DynamicDatasetIter(object):
    ...
    def from_opts(cls, corpora, transforms, fields, opts, is_train,
        ...
        return cls(
            ...
            stride=stride, offset=offset, is_context=opts.context
        )
    ...
    def _init_datasets(self):
        datasets_iterables = build_corpora_iters(
            ...
            stride=self.stride, offset=self.offset, is_context=self.is_context)
        self.dataset_adapter = DatasetAdapter(self.fields, self.is_train, self.is_context)
        datasets_weights = {
