...
from onmt.modules.embeddings import prepare_pretrained_embeddings, context_prepare_pretrained_embeddings
...
def prepare_fields_transforms(opt):
    ...
    if opt.context:
        context_prepare_pretrained_embeddings(opt, fields)
    else:
